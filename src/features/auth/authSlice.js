  ...
  extraReducers: (b) =>
    b
      ...
      .addCase(loginUser.fulfilled, (s, a) => {
        ...
        s.user = a.payload.usuario;
        window.localStorage.setItem("padelstore_token", a.payload.token);
        window.localStorage.setItem("padelstore_user", JSON.stringify(a.payload.usuario));
      })
