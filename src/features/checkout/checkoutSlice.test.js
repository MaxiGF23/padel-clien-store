...
describe("checkoutSlice", () => {
  it("builds checkout payload and stores the result", async () => {
    ...
    store.dispatch(addToCart({ product: { id: 1, nombreProducto: "Pala Bullpadel Hack 03", marca: "Bullpadel", nombreCategoria: "Palas", visual: "🏓", precio: 32000 }, quantity: 1 }));
    ...
    expect(store.getState().checkout.result).toMatchObject({ aprobado: true, estadoPago: "APROBADO", ultimos4: "1111" });
  });
});
